...
혜아는 이런 생각이 들었다. “int 앞에 long을 하나씩 더 붙일 때마다 4바이트씩 저장할 수 있는 공간이 늘어나는 걸까? 분명 long long long int는 12바이트, long long long long int는 16바이트까지 저장할 수 있는 정수 자료형일 거야!”
...
#Solution
'''
'long '을 N//4번 출력하고 뒤에 'int'를 더해 출력함
long과 long, long과 int 사이에 공백이 있으므로 'long'이 아닌 'long '를 N//4번 출력헤야함
'''